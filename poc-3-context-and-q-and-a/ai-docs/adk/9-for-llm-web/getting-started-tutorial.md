...
# Build Your First Intelligent Agent Team: A Progressive Weather Bot with ADK [¶](https://google.github.io/adk-docs/get-started/tutorial/\#build-your-first-intelligent-agent-team-a-progressive-weather-bot-with-adk "Permanent link")

[![Google Colaboratory logo](https://www.gstatic.com/pantheon/images/bigquery/welcome_page/colab-logo.svg)Open in Colab](https://colab.research.google.com/github/google/adk-docs/blob/main/examples/python/notebooks/adk_tutorial.ipynb)

Share to: [![LinkedIn logo](https://upload.wikimedia.org/wikipedia/commons/8/81/LinkedIn_icon.svg)](https://www.linkedin.com/sharing/share-offsite/?url=https%3A//github.com/google/adk-docs/blob/main/examples/python/notebooks/adk_tutorial.ipynb "Share on LinkedIn") [![Bluesky logo](https://upload.wikimedia.org/wikipedia/commons/7/7a/Bluesky_Logo.svg)](https://bsky.app/intent/compose?text=https%3A//github.com/google/adk-docs/blob/main/examples/python/notebooks/adk_tutorial.ipynb "Share on Bluesky") [![X logo](https://upload.wikimedia.org/wikipedia/commons/5/5a/X_icon_2.svg)](https://twitter.com/intent/tweet?url=https%3A//github.com/google/adk-docs/blob/main/examples/python/notebooks/adk_tutorial.ipynb "Share on X (Twitter)") [![Reddit logo](https://redditinc.com/hubfs/Reddit%20Inc/Brand/Reddit_Logo.png)](https://reddit.com/submit?url=https%3A//github.com/google/adk-docs/blob/main/examples/python/notebooks/adk_tutorial.ipynb "Share on Reddit") [![Facebook logo](https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg)](https://www.facebook.com/sharer/sharer.php?u=https%3A//github.com/google/adk-docs/blob/main/examples/python/notebooks/adk_tutorial.ipynb "Share on Facebook")
...
## Step 0: Setup and Installation [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-0-setup-and-installation "Permanent link")

### Library Installation [¶](https://google.github.io/adk-docs/get-started/tutorial/\#library-installation "Permanent link")
...
### Import Library [¶](https://google.github.io/adk-docs/get-started/tutorial/\#import-library "Permanent link")
...
### Setup API Keys [¶](https://google.github.io/adk-docs/get-started/tutorial/\#setup-api-keys "Permanent link")
...
### Define Model Constants for easier use [¶](https://google.github.io/adk-docs/get-started/tutorial/\#define-model-constants-for-easier-use "Permanent link")
...
## Step 1: Your First Agent - Basic Weather Lookup [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-1-your-first-agent-basic-weather-lookup "Permanent link")
...
### **1\. Define the Tool** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#1-define-the-tool "Permanent link")
...
### **2\. Define the Agent** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#2-define-the-agent "Permanent link")
...
### **3\. Setup Runner and Session Service** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#3-setup-runner-and-session-service "Permanent link")
...
### **4\. Interact with the Agent** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#4-interact-with-the-agent "Permanent link")
...
### **5\. Run the Conversation** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#5-run-the-conversation "Permanent link")
...
## Step 2: Going Multi-Model with LiteLLM [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-2-going-multi-model-with-litellm "Permanent link")
...
### **1\. Import `LiteLlm`** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#1-import-litellm "Permanent link")
...
### **2\. Define and Test Multi-Model Agents** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#2-define-and-test-multi-model-agents "Permanent link")
...
## Step 3: Building an Agent Team - Delegation for Greetings & Farewells [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-3-building-an-agent-team-delegation-for-greetings-farewells "Permanent link")
...
### **1\. Define Tools for Sub-Agents** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#1-define-tools-for-sub-agents "Permanent link")
...
### **2\. Define the Sub-Agents (Greeting & Farewell)** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#2-define-the-sub-agents-greeting-farewell "Permanent link")
...
### **3\. Define the Root Agent with Sub-Agents** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#3-define-the-root-agent-with-sub-agents "Permanent link")
...
### **4\. Interact with the Agent Team** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#4-interact-with-the-agent-team "Permanent link")
...
## Step 4: Adding Memory and Personalization with Session State [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-4-adding-memory-and-personalization-with-session-state "Permanent link")
...
### **1\. Initialize New Session Service and State** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#1-initialize-new-session-service-and-state "Permanent link")
...
### **2\. Create State-Aware Weather Tool** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#2-create-state-aware-weather-tool "Permanent link")
...
### **3\. Redefine Sub-Agents and Update Root Agent** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#3-redefine-sub-agents-and-update-root-agent "Permanent link")
...
### **4\. Interact and Test State Flow** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#4-interact-and-test-state-flow "Permanent link")
...
## Step 5: Adding Safety - Input Guardrail with `before_model_callback` [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-5-adding-safety-input-guardrail-with-before_model_callback "Permanent link")
...
### **1\. Define the Guardrail Callback Function** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#1-define-the-guardrail-callback-function "Permanent link")
...
### **2\. Update Root Agent to Use the Callback** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#2-update-root-agent-to-use-the-callback "Permanent link")
...
### **3\. Interact to Test the Guardrail** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#3-interact-to-test-the-guardrail "Permanent link")
...
## Step 6: Adding Safety - Tool Argument Guardrail ( `before_tool_callback`) [¶](https://google.github.io/adk-docs/get-started/tutorial/\#step-6-adding-safety-tool-argument-guardrail-before_tool_callback "Permanent link")
...
### **1\. Define the Tool Guardrail Callback Function** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#1-define-the-tool-guardrail-callback-function "Permanent link")
...
### **2\. Update Root Agent to Use Both Callbacks** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#2-update-root-agent-to-use-both-callbacks "Permanent link")
...
### **3\. Interact to Test the Tool Guardrail** [¶](https://google.github.io/adk-docs/get-started/tutorial/\#3-interact-to-test-the-tool-guardrail "Permanent link")
...
## Conclusion: Your Agent Team is Ready! [¶](https://google.github.io/adk-docs/get-started/tutorial/\#conclusion-your-agent-team-is-ready "Permanent link")
