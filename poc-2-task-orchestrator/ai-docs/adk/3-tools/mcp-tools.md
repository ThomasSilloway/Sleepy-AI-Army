...
## 1\. **Using MCP servers with ADK agents (ADK as an MCP client)** [¶](https://google.github.io/adk-docs/tools/mcp-tools/\#1-using-mcp-servers-with-adk-agents-adk-as-an-mcp-client "Permanent link")
...
#### Step 1: Attach the MCP Server to your ADK agent via `MCPToolset` [¶](https://google.github.io/adk-docs/tools/mcp-tools/\#step-1-attach-the-mcp-server-to-your-adk-agent-via-mcptoolset "Permanent link")
...
#### Step 2: Observe the result [¶](https://google.github.io/adk-docs/tools/mcp-tools/\#step-2-observe-the-result "Permanent link")
...
#### Step 2: Update get\_tools\_async [¶](https://google.github.io/adk-docs/tools/mcp-tools/\#step-2-update-get_tools_async "Permanent link")
...
#### Step 3: Observe the Result [¶](https://google.github.io/adk-docs/tools/mcp-tools/\#step-3-observe-the-result "Permanent link")
...
### Step 3: Test your MCP Server with ADK [¶](https://google.github.io/adk-docs/tools/mcp-tools/\#step-3-test-your-mcp-server-with-adk "Permanent link")
