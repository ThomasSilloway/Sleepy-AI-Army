...
def get_system_prompt(possible_git_branch_base_names: list[str]) -> str:
    ...
    3. Identify all file paths explicitly mentioned in the mission specification. You must categorize these files into two lists:
       ...
       If no files are mentioned for reading, 'files_to_read' should be an empty list (`[]`).
    ...
    Adhere strictly to the JSON schema for your output, ensuring 'git_branch_name' matches this 'type/description' format, 'files_to_edit' is a list of strings, and 'files_to_create' is a list of strings, etc.
"""
