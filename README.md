...
- Coding - Aider 
  ...
  - Note: Currently uses the prompting technique: Analyze -> Brainstorm -> Code -> Critique -> Modify. This is not the most cost efficient prompting technique, but it does get good results most of the time.
...
<center>
  <img src="docs\v0.1-changelist-pt1.png">
</center>

<center>
  <img src="docs\v0.1-changelist-pt2.png">
</center>
...
**How "Operation: Next Level" Helps:**
